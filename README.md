...
2. **Mô hình 2 (Tour chọn HDV linh hoạt):** Áp dụng cho các tour phổ thông. Khách chọn Tour $\rightarrow$ Xem danh sách HDV được đề xuất cho tour đó $\rightarrow$ Lựa chọn HDV ưa thích.
3. **Mô hình 3 (Guide-First - Đặt tour theo HDV):** Khách chọn HDV ưa thích trước $\rightarrow$ Xem danh sách các Tour sắp khởi hành do HDV đó dẫn $\rightarrow$ Tiến hành đặt lịch.
...
Truy cập thư mục Mobile App và cài đặt dependencies:

Bash
cd DPV.Mobile
npm install
Khởi chạy ứng dụng với Expo / Metro Bundler:
